# Projeto TrybeTunes
Esse projeto foi realizado para exercitar o que foi aprendido no Bloco 12 do Módulo de Front End do curso da [Trybe](https://www.betrybe.com/), no qual foi sobre `Componentes BrowserRouter` e `Route`, `Componente Link`, `Componentes Route com passagem de props`, `Componente Switch` e `Componente Redirect`.

[Link](https://lucas-almeida-sd.github.io/Trybe-Projeto_14-Trybetunes/) para a página do projeto.
